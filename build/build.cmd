...
set build_output="%artifacts_sources_path%\Serialize.Linq\bin\Release"
...
%msbuild% %artifacts_sources_path%\Serialize.Linq\Serialize.Linq.csproj /t:Rebuild /t:pack /p:Configuration="Release"
